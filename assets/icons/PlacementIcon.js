...
const SVGComponent = (props) => { // Define as functional component, accept props
  // Call useTheme inside the component
  const { isDark } = useTheme();

  // Determine the fill color based on the theme
  // If dark mode (isDark = true), use white. Otherwise (light mode), use black.
  ...
  return (
    <Svg
      ...
      id="Layer_1"
      viewBox="0 0 512 512"
      {...props} // Spread any passed props onto the Svg element
    >
      <G>
